...
def execute_dangerzone(filename):
    ...
    fn_rm = '~/Desktop/dangerzone/safe-output-compressed.pdf'
    if os.path.isfile(fn_rm):
        os.remove(fn_rm)

    # remove existing pixel file
    filelist = []
    mydir_pixel = '/tmp/dangerzone-pixel'
    ...
    filelist = []
    mydir_safe = '/tmp/dangerzone-safe'
    ...
    uploadpath = '/home/c0natus/Desktop/' + filename
    ...
    if filename_split[-1] in possible_format:
        ...
        if filename_split[-1] == 'hwp':
            ...
            htmldir_path = "/home/c0natus/Desktop/wkhtmltopdf"
            ...
            subprocess.call(["/home/c0natus/.local/bin/hwp5html " + uploadpath], shell=True)
            # convert to pdf
            subprocess.call(["/usr/bin/wkhtmltopdf " + os.getcwd() + "/" + filename[
        ...
        subprocess.call([
            "/usr/bin/dangerzone-container" " documenttopixels --document-filename " + uploadpath + " --pixel-dir /tmp/dangerzone-pixel --container-name flmcode/dangerzone"],
            shell=True)
        subprocess.call([
            "/usr/bin/dangerzone-container" " pixelstopdf --pixel-dir /tmp/dangerzone-pixel --safe-dir /tmp/dangerzone-safe --container-name flmcode/dangerzone --ocr 0 --ocr-lang eng"],
            shell=True)
    else:
    ...
    # copy to dest
    path = '/home/c0natus/Desktop/dangerzone/'
